	...
	<div class="row">
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading" align='center'>Create an Account</div>
				<div class="panel-body">
					<form role="form" action="" method="post" id="" name="signup" onsubmit="return checkpass();">
						...
						<fieldset>
							...
							<div class="checkbox">
								<button type="submit" value="submit" name="submit" class="btn btn-primary" style="width:100%">Register</button>
							</div>
						</fieldset>
						<hr />
						<div align='center'>
